...
#   timestamp: 2024-09-01 14:26:56.969619
...
from aind_data_schema_models.generators._base import _RegistryModel
...
class Ncbi(_RegistryModel):
    ...
    name: Literal["National Center for Biotechnology Information"] = (
...
class Orcid(_RegistryModel):
    ...
    name: Literal["Open Researcher and Contributor ID"] = (
...
class _Registry:
    ...
    class ONE_OF(RootModel):
        root: Annotated[
            Union[tuple(_RegistryModel.__subclasses__())], Field(discriminator="name")
        ]
